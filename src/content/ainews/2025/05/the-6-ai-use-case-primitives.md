---
title: The 6 AI Use Case Primitives
description: >-
  This episode of the AI Daily Brief podcast (recorded 2025-05-30) examines
  OpenAI's enterprise report, "Identifying and Scaling AI Use Cases: How Early
  Adopters Focus Their AI Efforts," and extends its framework into a
  forward-looking analysis of h...
...
1. **Content Creation** — drafting campaigns, emails, PRDs, scripts, repurposing content
2. **Research** — web search, competitive analysis, multi-step synthesis of sources
3. **Coding** — debugging, first-draft code, language porting, vibe-coding prototypes
4. **Data Analysis** — harmonising spreadsheets, identifying trends, scoring leads
5. **Ideation & Strategy** — brainstorming, strategic planning, pitch practice
6. **Automation** — recurring reports, Slack summaries, workflow triggers
